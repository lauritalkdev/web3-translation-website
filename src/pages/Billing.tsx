        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            <div style={{ 
              ...
              $7<span style={{ fontSize: 'clamp(0.875rem, 3vw, 1rem)', color: '#9CA3AF' }}>/month</span>
            </div>
            <p style={{ 
              color: '#9CA3AF', 
              marginBottom: '1.5rem',
          ...
          <div style={{ 
            ...
            <div style={{ 
              ...
              $40<span style={{ fontSize: 'clamp(0.875rem, 3vw, 1rem)', color: '#9CA3AF' }}>/6 months</span>
            </div>
            <div style={{ 
          ...
          <div style={{ 
            ...
            <div style={{ 
              ...
              $60<span style={{ fontSize: 'clamp(0.875rem, 3vw, 1rem)', color: '#9CA3AF' }}>/year</span>
            </div>
            <div style={{ 
              fontSize: 'clamp(0.75rem, 2.5vw, 0.9rem)', 
              color: '#D4AF37', 
      ...
      <footer style={{
        ...
        <div style={{
          ...
          <div style={{ 
            ...
            >
              {/* Facebook Icon */}
              <svg width="clamp(16px, 4vw, 20px)" height="clamp(16px, 4vw, 20px)" viewBox="0 0 24 24" fill="currentColor">
